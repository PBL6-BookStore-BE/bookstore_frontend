...
import {Button, Grid, GridItem, HStack, VStack, Text, Box, Flex, Image, AspectRatio } from "@chakra-ui/react";
            ...
            <GridItem colSpan={2}>
              ...
              <VStack align='flex-start' spacing={5} mb={10}>
                ...
                <Flex>
                  ...
                  <Text>
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aut dicta maiores voluptatibus itaque dolores repellat ratione. Rerum officiis deleniti corrupti nobis similique fugiat explicabo, iure, iusto optio ab esse quisquam.
                  </Text>
              </VStack>
            ...
            <VStack mt={6} align='flex-start'>
              {/* list book */}
              {
                topRating.data.map((item) => {
                  return (
                    <TopRatinginDetailBook key={item.id} {...item} />
                  )
                })
              }
